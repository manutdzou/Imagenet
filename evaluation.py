...
def _eval_once(saver, summary_writer, top_1_op, top_5_op, summary_op, model,labels):
  """Runs Eval once.
...
def evaluate(dataset):
  ...
  with tf.Graph().as_default():
    ...
    while True:
      _eval_once(saver, summary_writer, top_1_op, top_5_op, summary_op, model,labels)
      if FLAGS.run_once:
        break
